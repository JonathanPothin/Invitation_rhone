            ...
            <div style="font-family:'Barlow',Arial,Helvetica,sans-serif;max-width:560px;margin:0 auto;color:#1A2233">
              ...
              <div style="border:1px solid #D9DEE9;border-top:none;padding:24px;border-radius:0 0 10px 10px">
                ...
                <table style="width:100%;font-size:14px;border-collapse:collapse;margin:16px 0">
                  ...
                  <tr><td style="padding:6px 0;color:#5A6478">Horaire</td><td style="padding:6px 0">précisé prochainement — réunion suivie d'un apéritif dînatoire</td></tr>
                  <tr><td style="padding:6px 0;color:#5A6478">Lieu et horaire</td><td style="padding:6px 0">communiqués par email quelques jours avant l'événement</td></tr>
